...
const useAlertDialog = useOverlayBehavior

type AlertDialogProps = AlertDialogPrimitive.AlertDialogRootProps & OverlayBehaviorProps
...
type AlertDialogContentProps<T extends ValidComponent = "div"> =
  AlertDialogPrimitive.AlertDialogContentProps<T> & OverlayHandlers & {
...
const AlertDialogContent = <T extends ValidComponent = "div">(
  ...
  const [local, others] = splitProps(props as AlertDialogContentProps, [
    "class", "children", ...OVERLAY_HANDLER_KEYS,
  ])
  const handlers = createOverlayHandlers()

  return (
    <AlertDialogPortal>
      <Show when={alertDialog?.showBackdrop}>
        <AlertDialogOverlay />
      </Show>
...
type AlertDialogTitleProps<T extends ValidComponent = "h2"> =
  AlertDialogPrimitive.AlertDialogTitleProps<T> & { class?: string | undefined }
...
type AlertDialogDescriptionProps<T extends ValidComponent = "p"> =
  AlertDialogPrimitive.AlertDialogDescriptionProps<T> & { class?: string | undefined }
