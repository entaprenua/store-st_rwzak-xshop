    ...
    <Toast toastId={data.toastId} variant={props.variant} duration={props.duration}>
      <div class="flex items-start gap-3 w-full">
        ...
        {props.action && (
          <button
            type="button"
            class="shrink-0 text-sm font-medium hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2 rounded px-2 py-1 transition-colors"
            classList={{
              "text-primary hover:text-primary/80 focus:ring-ring": !props.variant || props.variant === "default",
              "text-destructive-foreground hover:text-destructive-foreground/80 focus:ring-destructive": props.variant === "destructive" || props.variant === "error",
              "text-success-foreground hover:text-success-foreground/80": props.variant === "success",
              "text-warning-foreground hover:text-warning-foreground/80": props.variant === "warning",
            }}
            onClick={() => {
