...
const useDropdownMenu = useOverlayBehavior

type DropdownMenuProps = DropdownMenuPrimitive.DropdownMenuRootProps & OverlayBehaviorProps
...
const DropdownMenu: Component<DropdownMenuProps> = (props) => {
  ...
  return (
    <OverlayBehavior {...local}>
      <DropdownMenuPrimitive.Root gutter={4} {...rest} />
    </OverlayBehavior>
  )
}

type DropdownMenuContentProps<T extends ValidComponent = "div"> =
  DropdownMenuPrimitive.DropdownMenuContentProps<T> & OverlayHandlers & {
...
const DropdownMenuContent = <T extends ValidComponent = "div">(
  ...
  const [, rest] = splitProps(props as DropdownMenuContentProps, [
...
type DropdownMenuSeparatorProps<T extends ValidComponent = "hr"> =
  DropdownMenuPrimitive.DropdownMenuSeparatorProps<T> & { class?: string | undefined }
...
const DropdownMenuSeparator = <T extends ValidComponent = "hr">(
  ...
  return (
    <DropdownMenuPrimitive.Separator class={cn("-mx-1 my-1 h-px bg-muted", props.class)} {...rest} />
  )
}

type DropdownMenuSubProps = DropdownMenuPrimitive.DropdownMenuSubProps & OverlayBehaviorProps

const DropdownMenuSub: Component<DropdownMenuSubProps> = (props) => {
  const [local, rest] = splitProps(props, OVERLAY_BEHAVIOR_KEYS)
  return (
    <OverlayBehavior {...local}>
      <DropdownMenuPrimitive.Sub gutter={4} {...rest} />
    </OverlayBehavior>
  )
}
...
type DropdownMenuSubContentProps<T extends ValidComponent = "div"> =
  DropdownMenuPrimitive.DropdownMenuSubContentProps<T> & OverlayHandlers & {
    class?: string | undefined
  }
...
type DropdownMenuGroupLabelProps<T extends ValidComponent = "span"> =
  DropdownMenuPrimitive.DropdownMenuGroupLabelProps<T> & { class?: string | undefined }
