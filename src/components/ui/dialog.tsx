...
const useDialog = useOverlayBehavior

type DialogProps = DialogPrimitive.DialogRootProps & OverlayBehaviorProps
...
const DialogPortal: Component<DialogPrimitive.DialogPortalProps> = (props) => {
  ...
  return (
    <DialogPrimitive.Portal {...rest}>
      <div class="relative flex items-start justify-center sm:items-center">
        {props.children}
      </div>
...
type DialogContentProps<T extends ValidComponent = "div"> =
  DialogPrimitive.DialogContentProps<T> & OverlayHandlers & {
