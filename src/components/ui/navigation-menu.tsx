...
const useNavigationMenu = useOverlayBehavior

type NavigationMenuProps<T extends ValidComponent = "ul"> =
  NavigationMenuPrimitive.NavigationMenuRootProps<T> & OverlayBehaviorProps & {
...
const NavigationMenu = <T extends ValidComponent = "ul">(
  ...
  const [local, others] = splitProps(props as NavigationMenuProps, [
    "class", "children", ...OVERLAY_BEHAVIOR_KEYS,
  ])
  return (
...
type NavigationMenuItemProps = NavigationMenuPrimitive.NavigationMenuMenuProps & OverlayBehaviorProps

const NavigationMenuItem = (props: NavigationMenuItemProps) => {
  return (
    <OverlayBehavior {...props}>
...
type NavigationMenuTriggerProps<T extends ValidComponent = "button"> =
  NavigationMenuPrimitive.NavigationMenuTriggerProps<T> & { class?: string | undefined }
...
type NavigationMenuViewportProps<T extends ValidComponent = "li"> =
  NavigationMenuPrimitive.NavigationMenuViewportProps<T> & OverlayHandlers & {
    class?: string | undefined
  }
...
type NavigationMenuContentProps<T extends ValidComponent = "ul"> =
  NavigationMenuPrimitive.NavigationMenuContentProps<T> & OverlayHandlers & {
    class?: string | undefined
  }
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Content
        class={cn(
          "pointer-events-none absolute left-0 top-0 box-border p-4 focus:outline-none data-[expanded]:pointer-events-auto data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[orientation=horizontal]:data-[motion=from-start]:slide-in-from-left-52 data-[orientation=horizontal]:data-[motion=to-end]:slide-out-to-right-52 data-[orientation=horizontal]:data-[motion=from-end]:slide-in-from-right-52 data-[orientation=horizontal]:data-[motion=to-start]:slide-out-to-left-52 data-[orientation=vertical]:data-[motion=from-start]:slide-in-from-top-52 data-[orientation=vertical]:data-[motion=to-end]:slide-out-to-bottom-52 data-[orientation=vertical]:data-[motion=from-end]:slide-in-from-bottom-52 data-[orientation=vertical]:data-[motion=to-start]:slide-out-to-bottom-52",
          local.class
        )}
        {...handlers}
        {...others}
